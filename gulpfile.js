...
function makeWebpackPkg() {
  ...
  makeModuleList(externalModules) - ${makeModuleList(externalModules)}`);
...
function bundle(dev, moduleArr) {
  ...
  console.log(`moduleArr - ${moduleArr}
   helpers.getArgModules() - ${ helpers.getArgModules() }
   modules - ${modules}
   typeof modules - ${Object.prototype.toString.call(modules) === '[object Array]'}
